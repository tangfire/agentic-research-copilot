...
class AppSettings(BaseModel):
    ...
    rerank_provider: Literal["rule", "dashscope", "qwen", "qwen3"] = "rule"
...
def load_settings() -> AppSettings:
    ...
    return AppSettings(
        ...
        rag_graph_enabled=_env_bool("ARC_RAG_GRAPH_ENABLED", False),
        ...
        rerank_provider=os.getenv("ARC_RERANK_PROVIDER", "rule").lower(),
