...
def _summarize_case(case: BenchmarkTask, run, summary) -> dict[str, Any]:
    ...
    return {
        ...
        "tool_completed_success_rate": summary.tool_completed_success_rate,
        "expected_tool_coverage": summary.expected_tool_coverage,
        "expected_evidence_coverage": summary.expected_evidence_coverage,
        ...
        "actual_completed_tools": summary.metadata.get("actual_completed_tools", []),
        "expected_evidence_kinds": case.expected_evidence_kinds,
        "actual_evidence_kinds": summary.metadata.get("actual_evidence_kinds", []),
...
def _aggregate_results(results: list[dict[str, Any]]) -> dict[str, Any]:
    return {
        ...
        "avg_tool_completed_success_rate": _avg(results, "tool_completed_success_rate"),
        "avg_expected_tool_coverage": _avg(results, "expected_tool_coverage"),
        "avg_expected_evidence_coverage": _avg(results, "expected_evidence_coverage"),
